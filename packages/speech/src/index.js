 ...
 *
 * @param {object} syncRecognizeRequest - A `SyncRecognizeRequest` object. See
 *     [`SyncRecognizeRequest`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.SyncRecognizeRequest).
 * @param {object} syncRecognizeRequest.config - A
 ...
 * @param {string} syncRecognizeRequest.config.encoding - Encoding of audio data
 *     sent in all `RecognitionAudio` messages. See
 ...
 * @param {number} syncRecognizeRequest.config.sampleRate - Sample rate in Hertz
 *     of the audio data sent in all RecognitionAudio messages. See
 ...
 * @param {string=} syncRecognizeRequest.config.languageCode - See
 ...
 *     Default: `"en-US"`.
 * @param {number=} syncRecognizeRequest.config.maxAlternatives - See
 ...
 *     Default: `1`.
 * @param {boolean=} syncRecognizeRequest.config.profanityFilter - See
 ...
 *     Default: `false`.
 * @param {string[]=} syncRecognizeRequest.config.speechContext - See
 ...
 *     Default: `[]`.
 * @param {object} syncRecognizeRequest.audio - A `RecognitionAudio` object.
 *     See [`RecognitionAudio`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionAudio).
 * @param {buffer} syncRecognizeRequest.audio.content - The audio data bytes
 *     encoded as specified in `RecognitionConfig`.
 * @param {string} syncRecognizeRequest.audio.uri - URI that points to a file
 *     that contains audio data bytes as specified in `RecognitionConfig`.
...
/**
 * Detect speech from an audio file.
 *
 ...
 *     Cloud Storage URI, or a gcloud File object.
 * @param {object} recognitionConfig - A
 *     `RecognitionConfig` object. See [`RecognitionConfig`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig).
 * @param {string} recognitionConfig.encoding - Encoding of audio data
 *     sent in all `RecognitionAudio` messages. See
 *     [`RecognitionConfig.encoding`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {number} recognitionConfig.sampleRate - Sample rate in Hertz
 *     of the audio data sent in all RecognitionAudio messages. See
 *     [`RecognitionConfig.sampleRate`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {string=} recognitionConfig.languageCode - See
 *     [`RecognitionConfig.languageCode`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `"en-US"`.
 * @param {number=} recognitionConfig.maxAlternatives - See
 *     [`RecognitionConfig.maxAlternatives`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `1`.
 * @param {boolean=} recognitionConfig.profanityFilter - See
 *     [`RecognitionConfig.profanityFilter`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `false`.
 * @param {string[]=} recognitionConfig.speechContext - See
 *     [`RecognitionConfig.speechContext`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `[]`.
 * @param {function} callback - The callback function.
 * @param {?error} callback.err - An error returned while making this request.
 ...
 * This method sends audio to the Speech API, which immediately responds with a
 * job ID. You can then poll the job for a result. This is useful if your app
 * doesn't need to wait for the result of the analysis.
 *
 * This is an advanced API method that requires a raw
 ...
 *
 * @param {object} asyncRecognizeRequest - A `AsyncRecognizeRequest` object. See
 *     [`AsyncRecognizeRequest`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.AsyncRecognizeRequest).
 * @param {object} asyncRecognizeRequest.config - A
 *     `RecognitionConfig` object. See [`RecognitionConfig`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig).
 * @param {string} asyncRecognizeRequest.config.encoding - Encoding of audio
 *     data sent in all `RecognitionAudio` messages. See
 *     [`RecognitionConfig.encoding`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {number} asyncRecognizeRequest.config.sampleRate - Sample rate in
 *     Hertz of the audio data sent in all RecognitionAudio messages. See
 *     [`RecognitionConfig.sampleRate`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {string=} asyncRecognizeRequest.config.languageCode - See
 *     [`RecognitionConfig.languageCode`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `"en-US"`.
 * @param {number=} asyncRecognizeRequest.config.maxAlternatives - See
 *     [`RecognitionConfig.maxAlternatives`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `1`.
 * @param {boolean=} asyncRecognizeRequest.config.profanityFilter - See
 *     [`RecognitionConfig.profanityFilter`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `false`.
 * @param {string[]=} asyncRecognizeRequest.config.speechContext - See
 *     [`RecognitionConfig.speechContext`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `[]`.
 * @param {object} asyncRecognizeRequest.audio - A `RecognitionAudio` object.
 *     See [`RecognitionAudio`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionAudio).
 * @param {buffer} asyncRecognizeRequest.audio.content - The audio data bytes
 *     encoded as specified in `RecognitionConfig`.
 * @param {string} asyncRecognizeRequest.audio.uri - URI that points to a file
 *     that contains audio data bytes as specified in `RecognitionConfig`.
 *     Currently, only Google Cloud Storage URIs are supported, which must be
 *     specified in the following format: `gs://bucket_name/object_name`.
 * @param {function} callback - The callback function.
 ...
 *
 * @param {object} streamingRecognizeRequest - A `StreamingRecognizeRequest`
 *     object. See [`StreamingRecognizeRequest`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.StreamingRecognizeRequest).
 * @param {object} streamingRecognizeRequest.streamingConfig - A
 *     `StreamingRecognitionConfig` object. See [`StreamingRecognitionConfig`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.StreamingRecognitionConfig).
 * @param {object} streamingRecognizeRequest.streamingConfig.config - A
 *     `RecognitionConfig` object. See [`RecognitionConfig`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig).
 * @param {string} streamingRecognizeRequest.streamingConfig.config.encoding -
 *     Encoding of audio data sent in all `RecognitionAudio` messages. See
 *     [`RecognitionConfig.encoding`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {number} streamingRecognizeRequest.streamingConfig.config.sampleRate
 *     - Sample rate in Hertz of the audio data sent in all RecognitionAudio
 *     messages. See
 *     [`RecognitionConfig.sampleRate`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {string=}
 *     streamingRecognizeRequest.streamingConfig.config.languageCode
 *     - See [`RecognitionConfig.languageCode`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `"en-US"`.
 * @param {number=}
 *     streamingRecognizeRequest.streamingConfig.config.maxAlternatives
 *     - See [`RecognitionConfig.maxAlternatives`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `1`.
 * @param {boolean=}
 *     streamingRecognizeRequest.streamingConfig.config.profanityFilter
 *     - See [`RecognitionConfig.profanityFilter`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `false`.
 * @param {string[]=}
 *     streamingRecognizeRequest.streamingConfig.config.speechContext
 *     - See [`RecognitionConfig.speechContext`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `[]`.
 * @param {boolean=} streamingRecognizeRequest.streamingConfig.singleUtterance
 *     - See [`StreamingRecognitionConfig.singleUtterance`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.StreamingRecognitionConfig.FIELDS).
 *     Default: `false`.
 * @param {boolean=} streamingRecognizeRequest.streamingConfig.interimResults
 *     - See [`StreamingRecognitionConfig.interimResults`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.StreamingRecognitionConfig.FIELDS).
 *     Default: `false`.
 ...
 * @resource [`StreamingRecognizeRequest` API Reference]{@link https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.StreamingRecognizeRequest}
 *
 * @param {object} streamingConfig - A `StreamingRecognitionConfig` object. See
 ...
 * @param {object} streamingConfig.config - A `RecognitionConfig` object. See
 ...
 * @param {string} streamingConfig.config.encoding - Encoding of audio data sent
 *     in all `RecognitionAudio` messages. See
 *     [`RecognitionConfig.encoding`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {number} streamingConfig.config.sampleRate - Sample rate in Hertz of
 *     the audio data sent in all `RecognitionAudio` messages. See
 *     [`RecognitionConfig.sampleRate`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 * @param {string=} streamingConfig.config.languageCode - See
 *     [`RecognitionConfig.languageCode`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `"en-US"`.
 * @param {number=} streamingConfig.config.maxAlternatives - See
 *     [`RecognitionConfig.maxAlternatives`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `1`.
 * @param {boolean=} streamingConfig.config.profanityFilter - See
 *     [`RecognitionConfig.profanityFilter`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `false`.
 * @param {string[]=} streamingConfig.config.speechContext - See
 *     [`RecognitionConfig.speechContext`](https://cloud.google.com/speech/reference/rpc/google.cloud.speech.v1beta1#google.cloud.speech.v1beta1.RecognitionConfig.FIELDS).
 *     Default: `[]`.
 * @param {boolean=} streamingConfig.singleUtterance - See
 ...
 *     Default: `false`.
 * @param {boolean=} streamingConfig.interimResults - See
